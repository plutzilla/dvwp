...
This plugin is designed to demonstrate security vulnerabilities and should never be used on production websites. The vulnerabilities are intentional and documented for educational purposes only.
